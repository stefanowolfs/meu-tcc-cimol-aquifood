...
import { setCoords, addDriverUser, updateUser } from '../../store/actions/userActions';


class DriverEditDriver extends Component {
   ...
   componentDidUpdate = () => {
      ...
      if (!!this.props.driver) {
         ...
         this.props.updateUser({ user_id: user_id, conta: 'motorista' });
...
export default connect(mapStateToProps, mapDispatchToProps)(DriverEditDriver);